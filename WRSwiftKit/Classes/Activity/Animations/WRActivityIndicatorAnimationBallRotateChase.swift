//
//  WRActivityIndicatorAnimationBallRotateChase.swift
//  WRSwiftUtilDemo
//
...
class WRActivityIndicatorAnimationBallRotateChase: WRActivityIndicatorAnimationDelegate {
    ...
    func setupAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        for i in 0 ..< 5 {
            ...
            let circle = WRActivityIndicatorShape.circle.layerWith(size: CGSize(width: circleSize, height: circleSize), color: color)
