//
//  WRActivityIndicatorAnimationAudioEqualizer.swift
//  WRSwiftUtilDemo
//
...
class WRActivityIndicatorAnimationAudioEqualizer: WRActivityIndicatorAnimationDelegate {
    ...
    func setupAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        for i in 0 ..< 4 {
            ...
            let line = WRActivityIndicatorShape.line.layerWith(size: CGSize(width: lineSize, height: size.height), color: color)
